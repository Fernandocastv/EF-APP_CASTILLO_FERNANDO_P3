...
public class DetailsUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String codigo) throws UsernameNotFoundException {
        Usuario usuario = usuarioService.UsuarioXCodigo(codigo);
        return crearUserDetails(usuario, ObtenerRoldelUsuario(usuario.getRol()));
    }

    public List<GrantedAuthority> ObtenerRoldelUsuario(String rol) {
