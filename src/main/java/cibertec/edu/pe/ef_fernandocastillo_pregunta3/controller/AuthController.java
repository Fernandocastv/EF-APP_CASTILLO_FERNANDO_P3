package cibertec.edu.pe.ef_fernandocastillo_pregunta3.controller;

import cibertec.edu.pe.ef_fernandocastillo_pregunta3.dto.request.UsuarioRequestDto;
import cibertec.edu.pe.ef_fernandocastillo_pregunta3.dto.response.UsuarioResponseDto;
...
import cibertec.edu.pe.ef_fernandocastillo_pregunta3.service.impl.DetailsUserService;
...
public class AuthController {
    ...
    private final String clave = "FernandoCastillo";
    ...
    public ResponseEntity<UsuarioResponseDto> autenticacionUsuario(@RequestBody UsuarioRequestDto usuarioRequestDto) {
        try {
            ...
            if(authentication.isAuthenticated()) {
                Usuario authUsuario = usuarioService.UsuarioXCodigo(usuarioRequestDto.getCodigo());
    ...
    private String generarToken(Usuario usuario) {
        List<GrantedAuthority> authorityList = detailsUserService.ObtenerRoldelUsuario(usuario.getRol());
        return Jwts.builder()
